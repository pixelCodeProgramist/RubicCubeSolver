    ...
    abstract class TwoPlacesTakenCrossBottomAbstractClass
    {
        ...
        protected void comleteSettingSquare(Color colorOnYellowSide, Color centroidColorOfWhiteSquare, Dictionary<Color, Side> rubicCubeSides, bool isStraightLine, List<Step> steps)
        {
            ...
            if (isStraightLine)
            {
                ...
                {
                    Movement movement = new Movement(MovementType.U_PRIM, rubicCubeSides, steps);
                    
                    movement = new Movement(up, rubicCubeSides, steps);
                ...
                {
                    Movement movement = new Movement(MovementType.U, rubicCubeSides, steps);
