...
namespace RubicCube.Models
{
    class Movement
    {
        ...
        public Movement(MovementType movementType, Dictionary<Color, Side> rubicCubeSides, List<Step> steps, bool canWriteToSteps = true)
        {
            ...
            if(canWriteToSteps) steps.Add(new Step(movementType, PreparationCube.copySides(rubicCubeSides)));
