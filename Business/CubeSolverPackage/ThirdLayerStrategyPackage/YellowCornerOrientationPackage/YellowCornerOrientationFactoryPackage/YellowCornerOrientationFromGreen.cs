...
{
    class YellowCornerOrientationFromGreen : IYellowCornerOrientation
    {
        private Dictionary<Color, Side> rubicCubeSides;
        private List<Step> steps;
        public YellowCornerOrientationFromGreen(Dictionary<Color, Side> rubicCubeSides, List<Step> steps)
        {
